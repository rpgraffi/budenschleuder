      ...
      <Card className="bg-white border border-slate-200/80 shadow-sm-clean rounded-2xl">
        <CardHeader className="pb-2">
          <CardTitle className="text-xs font-semibold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
            <Euro className="w-3.5 h-3.5" /> Durchschnittliche Budgets
          </CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            <div className="flex justify-between text-[11px] text-slate-500 font-medium">
              <span>Nachfrage Suchende (Suche)</span>
              <span className="font-semibold text-sky-600">{avgSearchBudget} € / Monat</span>
            </div>
          ...
          <div className="flex flex-col gap-1">
            <div className="flex justify-between text-[11px] text-slate-500 font-medium">
              <span>Angebotene Mieten (Biete)</span>
              <span className="font-semibold text-emerald-600">{avgOfferBudget} € / Monat</span>
            </div>
            <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
              <div
